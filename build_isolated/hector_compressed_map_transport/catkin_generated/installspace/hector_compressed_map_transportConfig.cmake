...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_compressed_map_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkinws/install_isolated/${idir}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkinws/install_isolated/lib;/home/pi/catkinws/devel_isolated/hector_map_tools/lib;/home/pi/catkinws/devel_isolated/geometry/lib;/home/pi/catkinws/devel_isolated/cv_bridge/lib;/home/pi/catkinws/devel_isolated/angles/lib;/home/pi/catkinws/devel/lib;/opt/ros/indigo/lib)
