...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/pi/catkinws/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/pi/catkinws/devel_isolated/eigen_conversions)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/pi/catkinws/install_isolated)
...
if(NOT "/home/pi/catkinws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/home/pi/catkinws/devel_isolated/orocos_kdl/share/orocos_kdl/../../include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkinws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/home/pi/catkinws/devel_isolated/orocos_kdl/share/orocos_kdl/../../include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkinws/src/geometry/eigen_conversions/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(eigen_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "eigen_conversions;/home/pi/catkinws/devel_isolated/orocos_kdl/lib/liborocos-kdl.so.1.4.0")
